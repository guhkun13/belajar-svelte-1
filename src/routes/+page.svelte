...
<div class="px-4 pt-6" >
    <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex flex-1 justify-end items-center text-base font-bold text-green-500 dark:text-green-400">
                12.5%
        ...
        <!-- Card Footer -->
        <div class="flex justify-between items-center pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
            <div>
                <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="weekly-sales-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="weekly-sales-dropdown">
                    ...
                    <ul class="py-1" role="none">
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Yesterday</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Today</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 7 days</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 30 days</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Last 90 days</a>
                        </li>
                    </ul>
                    <div class="py-1" role="none">
                        <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Custom...</a>
                    </div>
                </div>
            </div>
            <div class="flex-shrink-0">
    ...
    <div class="grid grid-cols-1 gap-4 mt-4 w-full md:grid-cols-2 xl:grid-cols-3">
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    ...
                    <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">New products this week</h3>
                </div>
            ...
            <div class="flex justify-between items-center pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div>
                    <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="new-products-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                    <!-- Dropdown menu -->
                    <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="new-products-dropdown">
                        <div class="py-3 px-4" role="none">
                            <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                                Sep 16, 2021 - Sep 22, 2021
                            </p>
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">5,355</span>
                    <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Visitors this week</h3>
                </div>
                <div class="flex flex-1 justify-end items-center ml-5 w-0 text-base font-bold text-green-500 dark:text-green-400">
                    32.9%
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Card Footer -->
            <div class="flex items-center justify-between border-t border-gray-200 pt-3 sm:pt-6 mt-3.5 dark:border-gray-700">
                <div>
                    <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="visitors-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                    <!-- Dropdown menu -->
                    <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="visitors-dropdown">
                        <div class="py-3 px-4" role="none">
                            <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                                Sep 16, 2021 - Sep 22, 2021
                            </p>
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    ...
                    <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">User signups this week</h3>
                </div>
            ...
            <div class="flex justify-between items-center pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div>
                    <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="week-signups-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                    <!-- Dropdown menu -->
                    <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="week-signups-dropdown">
                        <div class="py-3 px-4" role="none">
                            <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                                Sep 16, 2021 - Sep 22, 2021
                            </p>
    ...
    <div class="grid grid-cols-1 my-4 2xl:grid-cols-3 xl:gap-4">
        <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800 2xl:col-span-2 xl:mb-0">
            <div class="mb-4">
                <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Sessions by country</h3>
                <span class="text-base font-normal text-gray-500 dark:text-gray-400">View website visitors by hovering over the map</span>
            </div>
            ...
            <ul class="space-y-6" role="list">
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <filter id="filter0_d" x="1.22607" y="1.67188" width="8.58408" height="6.71428"
                            ...
                            <linearGradient id="paint0_linear" x1="1.22607" y1="1.67188" x2="1.22607" y2="7.38616"
                ...
                <span class="mx-5 ml-3 w-32 text-base font-medium text-gray-900 sm:flex-none dark:text-white">United States</span>
            </div>
            <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 35%"> 35%</div>
            </div>
        </li>
        <!-- Item 2 -->
        <li class="items-center w-full sm:flex">
            ...
            <div class="flex items-center mb-3 sm:mb-0">
                <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.25" y="0.779053" width="25.2567" height="16.6429" rx="1.75" fill="white" stroke="#F3F4F6"
                    stroke-width="0.5" />
                    <mask id="mask0" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="26" height="18">
                        <rect x="0.25" y="0.779053" width="25.2567" height="16.6429" rx="1.75" fill="white" stroke="white"
                        stroke-width="0.5" />
                    </mask>
                    <g mask="url(#mask0)">
                        <rect x="18.3975" y="0.529053" width="7.35907" height="17.1429" fill="#FF3131" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.6719H7.35907V0.529053H0V17.6719Z"
                        fill="#FF3131" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <span class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900 dark:text-white">Canada</span>
            </div>
            <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 26%"> 26%</div>
            </div>
        </li>
        <!-- Item 3 -->
        <li class="items-center w-full sm:flex">
            ...
            <div class="flex items-center mb-3 sm:mb-0">
                <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g mask="url(#mask0)">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.6719H8.58558V0.529053H0V17.6719Z"
                        fill="#1035BB" />
                    </g>
                </svg>
                <span class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900 dark:text-white">France</span>
            </div>
            <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 18%"> 18%</div>
            </div>
        </li>
        <!-- Item 4 -->
        <li class="items-center w-full sm:flex">
            ...
            <div class="flex items-center mb-3 sm:mb-0">
                <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.25" y="0.779297" width="25.2522" height="16.6429" rx="1.75" fill="white" stroke="#F3F4F6"
                    stroke-width="0.5" />
                    <mask id="mask0" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="26" height="18">
                        <rect x="0.25" y="0.779297" width="25.2522" height="16.6429" rx="1.75" fill="white" stroke="white"
                        stroke-width="0.5" />
                    </mask>
                    <g mask="url(#mask0)">
                        <rect x="17.168" y="0.529297" width="8.58408" height="17.1429" fill="#E43D4C" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.6722H8.58408V0.529297H0V17.6722Z"
                        fill="#1BB65D" />
                    </g>
                </svg>
                <span class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900 dark:text-white">Italy</span>
            </div>
            <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 14%"> 14%</div>
            </div>
        </li>
        <!-- Item 5 -->
        <li class="items-center w-full sm:flex">
            ...
            <div class="flex items-center mb-3 sm:mb-0">
                <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <linearGradient id="paint0_linear" x1="0" y1="0.529053" x2="0" y2="9.10048"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" />
                        <stop offset="1" stop-color="#F0F0F0" />
                    </linearGradient>
                    <linearGradient id="paint1_linear" x1="0" y1="0.529053" x2="0" y2="8.52905"
                    gradientUnits="userSpaceOnUse">
        ...
        <span class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900 dark:text-white">Australia</span>
    </div>
    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
        <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 10%"> 10%</div>
    </div>
</li>
<!-- Item 5 -->
<li class="items-center w-full sm:flex">
    ...
    <div class="flex items-center mb-3 sm:mb-0">
        <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0)">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 6.24334H25.7567V0.529053H0V6.24334Z"
                fill="#FFA44A" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.6718H25.7567V11.9575H0V17.6718Z"
                fill="#1A9F0B" />
                <path
        ...
        <span class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900 dark:text-white">India</span>
    </div>
    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
        <div class="p-1 h-5 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700" style="width: 7%"> 7%</div>
    </div>
</li>

</ul>
<!-- Card Footer -->
<div class="flex justify-between items-center pt-3 mt-6 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
    <div>
        <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="sessions-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
        <!-- Dropdown menu -->
        <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="sessions-dropdown">
            <div class="py-3 px-4" role="none">
                <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                    Sep 16, 2021 - Sep 22, 2021
                </p>
...
<div class="grid gap-4 sm:grid-cols-2 2xl:grid-cols-1">
    ...
    <div class="p-4 mb-4 h-full bg-white rounded-lg shadow sm:p-6 dark:bg-gray-800">
        ...
        <div class="flex justify-between items-center pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
            <div>
                <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="latest-customers-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="latest-customers-dropdown">
                    <div class="py-3 px-4" role="none">
                        <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                            Sep 16, 2021 - Sep 22, 2021
                        </p>
    ...
    <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
        <!-- Card Title -->
        <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Acquisition Overview</h3>
        <div id="traffic-channels-chart" class="py-6"></div>
        <div class="block overflow-x-auto w-full">
            <table class="items-center w-full bg-transparent border-collapse">
                <thead>
                    <tr>
                        <th class="py-3 px-4 text-xs font-semibold text-left text-gray-700 uppercase align-middle whitespace-nowrap bg-gray-50 rounded-l border-r-0 border-l-0 dark:bg-gray-700 dark:text-white">Top Channels</th>
                        <th class="py-3 px-4 text-xs font-semibold text-left text-gray-700 uppercase align-middle whitespace-nowrap bg-gray-50 border-r-0 border-l-0 dark:bg-gray-700 dark:text-white">Users</th>
                        <th class="py-3 px-4 text-xs font-semibold text-left text-gray-700 uppercase align-middle whitespace-nowrap bg-gray-50 rounded-r border-r-0 border-l-0 min-w-140-px dark:bg-gray-700 dark:text-white"></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Organic Search</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">5,649</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
                                <span class="mr-2 text-xs font-medium">30%</span>
                                <div class="relative w-full">
                                    <div class="w-full h-2 bg-gray-200 rounded-sm dark:bg-gray-700">
                                        <div class="h-2 rounded-sm bg-primary-700" style="width: 30%"></div>
                                    </div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Referral</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">4,025</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
                    ...
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Direct</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">3,105</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
                    ...
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Social</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">1251</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
                    ...
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Other</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">734</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
                    ...
                    <tr class="text-gray-500 dark:text-gray-400">
                        <th class="p-4 px-4 text-sm font-normal text-left align-middle whitespace-nowrap border-t-0">Email</th>
                        <td class="p-4 px-4 text-xs font-medium text-gray-900 align-middle whitespace-nowrap border-t-0 dark:text-white">456</td>
                        <td class="p-4 px-4 text-xs align-middle whitespace-nowrap border-t-0">
                            <div class="flex items-center">
        ...
        <div class="flex justify-between items-center pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
            <div>
                <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="aquisitions-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="aquisitions-dropdown">
                    <div class="py-3 px-4" role="none">
                        <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                            Sep 16, 2021 - Sep 22, 2021
                        </p>
...
<div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex-shrink-0">
            <a href="#" class="p-2 text-sm font-medium rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">View all</a>
        </div>
    </div>
    <!-- Table -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            ...
                            <tr class="bg-gray-50 dark:bg-gray-700">
                                ...
                                <td class="p-4 whitespace-nowrap">
                                    <span class="bg-purple-100 dark:bg-purple-200 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md">In progress</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
    ...
    <div class="flex justify-between items-center pt-3 sm:pt-6">
        <div>
            <button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" type="button" data-dropdown-toggle="transactions-dropdown">Last 7 days <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
            <!-- Dropdown menu -->
            <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="transactions-dropdown">
                <div class="py-3 px-4" role="none">
                    <p class="text-sm font-medium text-gray-900 truncate dark:text-white" role="none">
                        Sep 16, 2021 - Sep 22, 2021
                    </p>
